...
class DetailsPanel extends StatelessWidget {
  ...
  const DetailsPanel({super.key, required this.baseColor, required this.restoredIcon});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DetailRow('Meets WCAG AA on white', '${baseColor.meetsWcagAA(Colors.white)}'),
            DetailRow('Contrast ratio on white', contrastRatio.toStringAsFixed(2)),
