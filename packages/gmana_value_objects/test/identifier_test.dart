...
void main() {
  group('IdentifierValue', () {
    test('parses valid UUID successfully', () {
      const config = IdentifierValidationConfig(
    ...
    test(
      'constructor succeeds for valid input and throws for invalid input',
      () {
        expect(
          () => IdentifierValue(
            '01ARZ3NDEKTSV4RRFFQ69G5FAV',
            config: const IdentifierValidationConfig(
              requiredType: IdentifierType.ulid,
            ),
          ),
          returnsNormally,
        );
